...
const AdminProfile = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      // Initialize with empty values if user is not available yet
      setFormData({
        name: '',
        email: '',
        avatar: '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Always send name and email, only send avatar if it was updated
    ...
    <div className="w-full">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage your admin profile information</p>
        </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute bottom-0 right-0 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors border-2 border-white"
                  >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-blue-900 mb-1">Profile Picture</h4>
